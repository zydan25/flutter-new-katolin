...
class _ShopikAppState extends State<ShopikApp> {
  ...
  Future<void> _boot() async { await context.read<AppController>().restore(); if (mounted) setState(() => booting = false); }
