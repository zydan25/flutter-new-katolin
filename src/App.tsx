...
import { fetchLiveUserProfile, fetchLiveServerReports, fetchLiveWalletBalance } from "./services/apiService";
...
export default function App() {
  ...
  if (!isLoggedIn) {
    return (
      <div className="flex justify-center bg-slate-900 min-h-screen py-2 px-2 sm:py-6" dir="rtl">
        <div className="w-full max-w-[430px] bg-slate-900 min-h-[860px] shadow-2xl rounded-3xl overflow-hidden flex flex-col relative border border-slate-700">
  ...
  return (
    <div className="flex justify-center bg-slate-900 min-h-screen py-2 px-2 sm:py-6" dir="rtl">
      {/* Mobile Frame */}
      <div className="w-full max-w-[430px] bg-[#F4F6F9] min-h-[860px] shadow-2xl rounded-3xl overflow-hidden flex flex-col relative border border-slate-700">
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          {activeScreen === "operations" && (
            <OperationsView
              ...
              onSelectOperation={(op) => setSelectedOpForDetail(op)}
              onRefresh={() => runInquiry("balance")}
            />
          )}

          {activeScreen === "reports" && (
            <ReportsScreen onBack={() => setActiveScreen("main_home")} />
          )}
            ...
            <div className="space-y-3">
              ...
              <div className="bg-white rounded-2xl p-3 shadow-sm border border-slate-200">
                <div className="grid grid-cols-3 text-center items-center divide-x divide-x-reverse divide-slate-100">
                  ...
                  <div>
                    <div className="text-[11px] text-slate-500 font-bold mb-1">رصيد الرقم</div>
                    <div className="text-sm font-extrabold text-[#0284C7]">
                      {ymPhoneBalance || "436.04"}
                    </div>
                  </div>
              ...
              {/* Sub-Filter Tabs (دفع مسبق | فوترة | شريحة | برمجة | 4G) - Matches Screenshot 7 */}
              <div className="flex bg-white p-1 rounded-xl gap-1 text-[11px] font-bold text-slate-600 border border-slate-200 shadow-sm overflow-x-auto no-scrollbar">
                {["دفع مسبق", "فوترة", "شريحة", "برمجة", "4G"].map((sub) => {
        ...
        <div className="bg-white border-t border-slate-200 px-2 py-1.5 flex items-center justify-around shadow-lg z-20 shrink-0">
          <button
            onClick={() => setActiveScreen("store")}
            className={`flex flex-col items-center justify-center py-1 px-2.5 rounded-xl transition ${
              activeScreen === "store" ? "text-emerald-700 font-black scale-105" : "text-slate-400 font-bold"
            }`}
          >
          ...
          <button
            onClick={() => setActiveScreen("main_home")}
            className={`flex flex-col items-center justify-center py-1 px-2.5 rounded-xl transition ${
              activeScreen === "main_home" ? "text-[#8B1D3B] font-black scale-105" : "text-slate-400 font-bold"
            }`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center py-1 px-2 rounded-xl transition ${
              activeScreen === "payment" ? "text-[#8B1D3B] font-black" : "text-slate-400 font-bold"
            }`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center py-1 px-2 rounded-xl transition ${
              activeScreen === "operations" ? "text-[#8B1D3B] font-black" : "text-slate-400 font-bold"
            }`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center py-1 px-2 rounded-xl transition ${
              activeScreen === "statement" ? "text-[#8B1D3B] font-black" : "text-slate-400 font-bold"
            }`}
          >
            <FileText className="w-5 h-5 mb-0.5" />
            <span className="text-[10px]">كشف حساب</span>
          </button>

          <button
            onClick={() => setActiveScreen("reports")}
            className={`flex flex-col items-center justify-center py-1 px-2.5 rounded-xl transition ${
              activeScreen === "reports" ? "text-[#8B1D3B] font-black" : "text-slate-400 font-bold"
            }`}
          >
