...
export const WifiNetworksScreen: React.FC<Props> = ({
  ...
  // Purchased Cards History from localStorage
    ...
    return [
      {
        ...
        netName: "شبكة زين نت",
        location: "إب - الظهار",
        ownerPhone: "774952665",
        buyerPhone: "774952665",
        denominationTitle: "كرت 200 ريال",
        faceValue: "200.00",
        price: 180,
        pin: "849204928172",
        serial: "SN-92810482",
  ...
  const loadNetworks = async () => {
    setLoading(true);
    try {
      const serverNets = await fetchLiveWifiNetworks();
